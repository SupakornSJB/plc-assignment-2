...
def test_call_single_arg():
    assert parse("f(a)") == ('call', 'f', [('var', 'a')])


def test_call_multiple_args():
    assert parse("f(a, b, c)") == ('call', 'f', [('var', 'a'), ('var', 'b'), ('var', 'c')])


def test_call_expr_arg():
    assert parse("f(a + b)") == ('call', 'f', [('+', ('var', 'a'), ('var', 'b'))])


def test_call_nested():
    assert parse("f(g(a))") == ('call', 'f', [('call', 'g', [('var', 'a')])])


def test_call_in_expr():
    assert parse("f(a) + b") == ('+', ('call', 'f', [('var', 'a')]), ('var', 'b'))
